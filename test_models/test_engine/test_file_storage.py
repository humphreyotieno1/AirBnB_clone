...
class TestFileStorage(unittest.TestCase):
    ...
    def setUpClass(cls):
        cls.rev1 = Review()
        cls.rev1.place_id = "Bridgeways"
        cls.rev1.user_id = "Humphrey"
        cls.rev1.text = "Great"
    ...
    def test_new(self):
        ...
        Immaculate = User()
        Immaculate.id = 000000
        Immaculate.name = "Immaculate"
        m_storage.new(Immaculate)
        key = Immaculate.__class__.__name__ + "." + str(Immaculate.id)
